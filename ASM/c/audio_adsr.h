...
typedef struct AdsrSubData {
    /* 0x00 */ //s32 isUsed;
    /* 0x04 */ s32 startDelay;
    /* 0x08 */ f32 startCurrent;
    /* 0x0C */ f32 invStartDelay;
} AdsrSubData; // size = 0x10
